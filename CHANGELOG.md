...
## 06-01-2022 
- Officialisation d'une v1

## 06-01-2022
 ## Added 
- Finalisation du design
- Gestion de la win
- redirection avec retour websocket
...
- Ajout d'un bouton pour voir les scores en version mobile
- Ajout d'un système pour afficher les users
